...
import br.edu.atitus.denguealerta.dtos.SigninDT0;
...
public class AuthController {
	...
	@PostMapping("/signin") 
	public ResponseEntity<String> signin(@RequestBody SigninDT0 signinDTO) throws AuthenticationException, Exception {
